...
namespace QL_HangHoa.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\C#_quanly\QL_HangHoa\QL_HangHoa\QL_HangHoa.mdf;Integrated Security=True;Connect Timeout=30";
            Con.Open();                 
